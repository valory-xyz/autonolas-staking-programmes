...
async function main() {
    ...
    console.log("10. EOA to deploy ContributeActivityChecker");
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/verify_10_contribute_activity_checker.js --network " + providerName + " " + contributeActivityChecker.address, { encoding: "utf-8" });
    }
}
