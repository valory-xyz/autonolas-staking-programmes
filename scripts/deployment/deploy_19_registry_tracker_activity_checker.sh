...
registryTrackerProxyAddress=$(jq -r '.registryTrackerProxyAddress' globals.json)
...
echo "$(jq '. += {"registryTrackerActivityCheckerAddress":"'$registryTrackerActivityCheckerAddress'"}' globals.json)" > globals.json
...
if [ "$contractVerification" == "true" ]; then
  ...
  forge verify-contract \
    ...
    "$registryTrackerActivityCheckerAddress" \
    "$contractPath" \
