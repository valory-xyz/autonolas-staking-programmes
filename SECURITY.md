# Security Policy
This document outlines security procedures and general policies for the `autonolas-staking-programmes` project.
...
The `autonolas-staking-programmes` team and community take all security bugs in `autonolas-staking-programmes` very seriously.
Thank you for improving the security of `autonolas-staking-programmes`. We appreciate your efforts and responsible disclosure and will make
